              ...
              <Grid container direction="column" spacing={3}>
                <Grid item>
                  <Typography variant="body2" className={classes.iconPara}>
                    Innovation Energy Experts provides Air Pressure Test for
                    dwellings. Air tightness testing or Air Pressure Test is the
                    procedure to trace any unwanted drafts and uncontrolled
                    airflow through a building. Too much air leakage leads to
                    heat loss resulting in higher CO2 emissions Building
                    Regulations Part L1A for new dwellings and Part L2A for new
                    buildings other than dwellings came into force in April
                    2006, requiring that standards of air tightness in new
                    properties are both achieved and proven by the means of Air
                    leakage Testing and an air leakage test certificate.
                  </Typography>
                </Grid>
                {/* <Grid item>
                            <Typography
