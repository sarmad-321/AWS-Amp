  ...
  return (
    <Container>
      <Grid
        ...
        lg={12}
        spacing-sm-2
        className={classes.OfficeContainer}
      >
        ...
        <Grid
          ...
          spacing={1}
          spacing-sm-2
          className={classes.officePicContainer}
        >
          <Grid
            item
            spacing={0}
          ...
          >
            <Grid container className={classes.peterBourough}>
              ...
              >
                Tell us how we can help. Book session with one of our storage
                experts to discuss your requirments in detail.
              </Typography>
              {/* </Grid>             */}
              <Grid item xs={12} md={12} lg={12}>
                <form
